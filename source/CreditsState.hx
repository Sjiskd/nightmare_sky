...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
			...
			['M.A. Jigsaw',		    'majigsaw',		    'Main Coder of The Port',	 'https://www.youtube.com/channel/',	'0xFFC30085'],
			['Port This Mod'],
			['Red Engineer ch',		    'zeonplay',		    'The Port Mods',	 'https://youtube.com/channel/UC2F9tDqRX5J6FwjZeBDeZ2Q',	'0xFF50A0FF'],
			['Psych Engine Team'],
